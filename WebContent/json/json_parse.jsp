...
<body>
	...
	<h1>부서정보 출력하기 - json을 텍스트 형태로 전달받은 경우</h1>
	...
	<script type="text/javascript">
		var deptlist = '{"dept":'
				...
				+ '{"code":"004", "name":"전산팀","loc":"5층"}' + ']' + '}';
		// 텍스트의 형태로 json이 전달되는 경우 
		// 자바스크립트에서 사용하려면 텍스트를 json객체로 변환하는 작업을 해야 한다. → 파싱

		// eval 함수를 이용해서 json을 실행 ; 원래는 eval함수 사용 ㄴㄴ
